    ...
    render() {
        ...
        return (
            <div className="text-white text-left flex flex-col items-center">
                ...
                <h1 className="text-5xl font-bold font-primary mb-5 ml-20 mr-20">About Me</h1>

                <div className='flex justify-center gap-10 w-full'>

                    <CardItem 
                        icon=<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 mb-2" style={ {color: "#3BBA9C"} }>
                    ...
                    <CardItem 
                        ...
                        description="I am not only merley building personal projects, but I have the courage and ambition to lead people in order to reach simillar goals. 
                        This can be seen in my proven track record of leading committees to deliver tangible results and create meaningful impact. Throughout my journey, I 
                        have empowered teams to achieve their full potential, fostering a collaborative environment that values innovation, and collective growth."
                    />
