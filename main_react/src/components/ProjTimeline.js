            ...
            <div className="flex flex-row">
                <div>
                    ...
                    <TimelineBody className="pb-8 w-[700px]">
                        ...
                        <Typography color="white" className="font-primary text-justify mb-5">
                            This platform, constructed using ReactJS and TailwindCSS for frontend aesthetics, 
                            coupled with Django for backend functionality, serves as a comprehensive showcase. Explore a 
